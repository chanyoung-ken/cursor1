...
export default function LandingPage(props: LandingPageProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-yellow-300 via-orange-400 to-red-400 p-4 text-center select-none">
      <main className="flex flex-col items-center justify-center w-full flex-1">
        <Card className="w-full max-w-md shadow-2xl bg-white/95 backdrop-blur-sm rounded-xl overflow-hidden">
